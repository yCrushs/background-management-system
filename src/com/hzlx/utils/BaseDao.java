    ...
    public T selectOne(String sql, Class clazz, Object... objs) {
        ...
        try {
            ...
            if (resultSet.next()) {
                ...
                //通过属性得名字找对应的set方法  执行set方法  去完成赋值操作
    ...
    public List<Map<String, Object>> selectListForMap(String sql, Object... objects) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                for (int i = 1; i <= columnCount; i++) {
                    //获取列名
                    String coulumnName = metaData.getColumnLabel(i);
                    //根据列名获取结果
                    Object value = resultSet.getObject(coulumnName);
                    //把cloumnName作为key放入map中
                    map.put(coulumnName, value);
                }
                list.add(map);
            }
        } catch (SQLException e) {
