                                ...
                                <ul class=" nav nav-subnav">
                                    <c:if test="${not empty menu.list}">
                                        <c:forEach var="menuItem" items="${menu.list}">
                                            <li <c:if test="${menuItem.id==5}"> class="active"</c:if> ><a
                            ...
                            <div class="card-toolbar clearfix">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="href1">
                                                    </div>
                                                    <div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" class="btn btn-primary" onclick="saveMenu1()">保存</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="toolbar-btn-action">
                                    ...
                                    <a class="btn btn-success m-r-5" href="#!"
                                       onclick="qiyong(${menu.id})"
                                    ><i class="mdi mdi-check"
                                    ></i> 启用</a>
                                    <a class="btn btn-warning m-r-5" href="#!"><i class="mdi mdi-block-helper"></i> 禁用</a>
                                    <a class="btn btn-danger" href="#!"
                                       onclick="menudeletebtn(${menu.id})"
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="menu" items="${menus}" varStatus="status">
                                            <tr>
                                                ...
                                                <td>${menu.href}</td>
                                                <td>${menu.pName}</td>
                                                <td><fmt:formatDate value="${menu.create_time}" pattern="yyyy年MM月dd日 HH:mm:ss"></fmt:formatDate> </td>
                                                <td>
                                                ...
                                                <div class="modal-body">
                                                    <form>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="pid1"
...
<script type="text/javascript">
    ...
    function menudeletebtn(){
        ...
        if (confirm("确认删除吗？")) {
            $.ajax({
                url: "${ctx}/api/menu/menudeletebtn",
                type: "post",
                dataType: "json",
                data: {
                    id: sz
